...
public class Generate extends AbstractAcceleoGenerator {
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(ucdiagram.UcdiagramPackage.class)) {
            resourceSet.getPackageRegistry().put(ucdiagram.UcdiagramPackage.eINSTANCE.getNsURI(), ucdiagram.UcdiagramPackage.eINSTANCE);
        }
