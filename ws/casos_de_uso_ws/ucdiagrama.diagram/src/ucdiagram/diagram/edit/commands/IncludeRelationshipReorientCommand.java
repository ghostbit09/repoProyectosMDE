 ...
 * @generated
 */
public class IncludeRelationshipReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public IncludeRelationshipReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ucdiagram.includeRelationship) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return UcdiagramBaseItemSemanticEditPolicy.getLinkConstraints().canExistIncludeRelationship_4002(container,
	...
	* @generated
	*/
	protected ucdiagram.includeRelationship getLink() {
		return (ucdiagram.includeRelationship) getElementToEdit();
	}
