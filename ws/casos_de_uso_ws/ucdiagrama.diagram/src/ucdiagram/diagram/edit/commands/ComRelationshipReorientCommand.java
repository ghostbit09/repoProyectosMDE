 ...
 * @generated
 */
public class ComRelationshipReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ComRelationshipReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ucdiagram.comRelationship) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return UcdiagramBaseItemSemanticEditPolicy.getLinkConstraints().canExistComRelationship_4001(container,
	...
	* @generated
	*/
	protected ucdiagram.comRelationship getLink() {
		return (ucdiagram.comRelationship) getElementToEdit();
	}
