 ...
 * @generated
 */
public class ActorItemSemanticEditPolicy extends UcdiagramBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ActorItemSemanticEditPolicy() {
		super(UcdiagramElementTypes.Actor_2002);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (UcdiagramVisualIDRegistry.getVisualID(outgoingLink) == ComRelationshipEditPart.VISUAL_ID) {
