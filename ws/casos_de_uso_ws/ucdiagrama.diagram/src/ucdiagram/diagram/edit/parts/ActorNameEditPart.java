...
public class ActorNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UcdiagramParserProvider.getParser(UcdiagramElementTypes.Actor_2002, getParserElement(),
					UcdiagramVisualIDRegistry.getType(ucdiagram.diagram.edit.parts.ActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
