 ...
 * @generated
 */
public class LimitBoxNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LimitBoxNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return UcdiagramElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UcdiagramParserProvider.getParser(UcdiagramElementTypes.LimitBox_2004, getParserElement(),
					UcdiagramVisualIDRegistry.getType(ucdiagram.diagram.edit.parts.LimitBoxNameEditPart.VISUAL_ID));
		}
		return parser;
	}
