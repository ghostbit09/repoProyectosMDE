...
public class UseCaseNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UcdiagramParserProvider.getParser(UcdiagramElementTypes.UseCase_3001, getParserElement(),
					UcdiagramVisualIDRegistry.getType(ucdiagram.diagram.edit.parts.UseCaseNameEditPart.VISUAL_ID));
		}
		return parser;
	}
