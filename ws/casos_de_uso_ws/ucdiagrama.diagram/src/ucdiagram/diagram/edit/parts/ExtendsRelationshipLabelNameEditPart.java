 ...
 * @generated
 */
public class ExtendsRelationshipLabelNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UcdiagramVisualIDRegistry.getType(
				ucdiagram.diagram.edit.parts.ExtendsRelationshipLabelNameEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public ExtendsRelationshipLabelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UcdiagramParserProvider.getParser(UcdiagramElementTypes.ExtendsRelationship_4003,
					getParserElement(), UcdiagramVisualIDRegistry
							.getType(ucdiagram.diagram.edit.parts.ExtendsRelationshipLabelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ExtendsRelationshipLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExtendsRelationshipLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ExtendsRelationshipLabelFigure() {
			this.setText("extendsRelationship");
		}
