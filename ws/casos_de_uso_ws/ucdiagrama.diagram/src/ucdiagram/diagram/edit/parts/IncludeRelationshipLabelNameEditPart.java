...
import ucdiagram.diagram.edit.policies.UcdiagramTextSelectionEditPolicy;
 ...
 * @generated
 */
public class IncludeRelationshipLabelNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UcdiagramVisualIDRegistry.getType(
				ucdiagram.diagram.edit.parts.IncludeRelationshipLabelNameEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public IncludeRelationshipLabelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new UcdiagramTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UcdiagramParserProvider.getParser(UcdiagramElementTypes.IncludeRelationship_4002,
					getParserElement(), UcdiagramVisualIDRegistry
							.getType(ucdiagram.diagram.edit.parts.IncludeRelationshipLabelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, UcdiagramEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new IncludeRelationshipLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IncludeRelationshipLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IncludeRelationshipLabelFigure() {
			this.setText("includeRelationship");
		}
