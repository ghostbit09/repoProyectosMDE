...
public class MBSClaseNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MBSClase_2001, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MBSClaseNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
