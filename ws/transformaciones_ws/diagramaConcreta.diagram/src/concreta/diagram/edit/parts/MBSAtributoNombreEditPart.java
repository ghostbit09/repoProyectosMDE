...
public class MBSAtributoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MBSAtributo_3001, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MBSAtributoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
