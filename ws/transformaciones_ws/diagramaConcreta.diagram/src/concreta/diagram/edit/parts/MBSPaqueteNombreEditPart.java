...
public class MBSPaqueteNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MBSPaquete_2002, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MBSPaqueteNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
