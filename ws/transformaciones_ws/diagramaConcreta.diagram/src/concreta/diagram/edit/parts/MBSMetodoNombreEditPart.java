...
public class MBSMetodoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MBSMetodo_3002, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MBSMetodoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
