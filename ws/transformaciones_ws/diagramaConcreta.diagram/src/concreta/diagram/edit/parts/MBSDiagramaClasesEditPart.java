...
import concreta.diagram.edit.policies.MBSDiagramaClasesCanonicalEditPolicy;
import concreta.diagram.edit.policies.MBSDiagramaClasesItemSemanticEditPolicy;
...
public class MBSDiagramaClasesEditPart extends DiagramEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MBSDiagramaClasesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new MBSDiagramaClasesCanonicalEditPolicy());
