 ...
 * </p>
 * <ul>
 *   <li>{@link diagramaAbstracta.impl.MBSClaseImpl#getIdClase <em>Id Clase</em>}</li>
 *   <li>{@link diagramaAbstracta.impl.MBSClaseImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link diagramaAbstracta.impl.MBSClaseImpl#getEstereotipo <em>Estereotipo</em>}</li>
 *   <li>{@link diagramaAbstracta.impl.MBSClaseImpl#getModificadorAcceso <em>Modificador Acceso</em>}</li>
 *   <li>{@link diagramaAbstracta.impl.MBSClaseImpl#isAbstracta <em>Abstracta</em>}</li>
 *   <li>{@link diagramaAbstracta.impl.MBSClaseImpl#getDescripcion <em>Descripcion</em>}</li>
 *   <li>{@link diagramaAbstracta.impl.MBSClaseImpl#getAtributos <em>Atributos</em>}</li>
 *   <li>{@link diagramaAbstracta.impl.MBSClaseImpl#getMetodos <em>Metodos</em>}</li>
 *   <li>{@link diagramaAbstracta.impl.MBSClaseImpl#getListaRelaciones <em>Lista Relaciones</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBSClaseImpl extends EObjectImpl implements MBSClase {
	...
	protected EClass eStaticClass() {
		return DiagramaAbstractaPackage.Literals.MBS_CLASE;
	}
	...
	public void setIdClase(String newIdClase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaAbstractaPackage.MBS_CLASE__ID_CLASE, oldIdClase, idClase));
	}
	...
	public void setNombre(String newNombre) {
		...
		nombre = newNombre;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaAbstractaPackage.MBS_CLASE__NOMBRE, oldNombre, nombre));
	}
	...
	public void setEstereotipo(String newEstereotipo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaAbstractaPackage.MBS_CLASE__ESTEREOTIPO, oldEstereotipo, estereotipo));
	}
	...
	public void setModificadorAcceso(String newModificadorAcceso) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaAbstractaPackage.MBS_CLASE__MODIFICADOR_ACCESO, oldModificadorAcceso, modificadorAcceso));
	}
	...
	public void setAbstracta(boolean newAbstracta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaAbstractaPackage.MBS_CLASE__ABSTRACTA, oldAbstracta, abstracta));
	}
	...
	public void setDescripcion(String newDescripcion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaAbstractaPackage.MBS_CLASE__DESCRIPCION, oldDescripcion, descripcion));
	}
	...
	public EList<MBSAtributo> getAtributos() {
		if (atributos == null) {
			atributos = new EObjectContainmentEList<MBSAtributo>(MBSAtributo.class, this, DiagramaAbstractaPackage.MBS_CLASE__ATRIBUTOS);
		}
		return atributos;
	}
	...
	public EList<MBSMetodo> getMetodos() {
		if (metodos == null) {
			metodos = new EObjectContainmentEList<MBSMetodo>(MBSMetodo.class, this, DiagramaAbstractaPackage.MBS_CLASE__METODOS);
		}
		return metodos;
	}
	...
	public EList<MBSRelacion> getListaRelaciones() {
		if (listaRelaciones == null) {
			listaRelaciones = new EObjectContainmentEList<MBSRelacion>(MBSRelacion.class, this, DiagramaAbstractaPackage.MBS_CLASE__LISTA_RELACIONES);
		}
