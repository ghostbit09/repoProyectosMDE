...
public class PrimaryKeyItemProvider extends ColumnItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimaryKey_tableName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimaryKey_tableName_feature", "_UI_PrimaryKey_type"),
				 Sql_metamodelPackage.Literals.PRIMARY_KEY__TABLE_NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimaryKey.class)) {
			case Sql_metamodelPackage.PRIMARY_KEY__TABLE_NAME:
