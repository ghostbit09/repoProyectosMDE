...
/**
 * This is the item provider adapter for a {@link sql_metamodel.ForeignKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sql_metamodelPackage.Literals.FOREIGN_KEY__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sql_metamodelPackage.Literals.FOREIGN_KEY__PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
