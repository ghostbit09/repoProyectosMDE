...
/**
 * This is the item provider adapter for a {@link sql_metamodel.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider extends ModelElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Sql_metamodelPackage.Literals.TABLE__LIST_PRIMARY_KEYS);
			childrenFeatures.add(Sql_metamodelPackage.Literals.TABLE__LIST_FOREIGN_KEYS);
			childrenFeatures.add(Sql_metamodelPackage.Literals.TABLE__LIST_COLUMNS);
			childrenFeatures.add(Sql_metamodelPackage.Literals.TABLE__LIST_RELATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Sql_metamodelPackage.Literals.TABLE__LIST_PRIMARY_KEYS,
				 Sql_metamodelFactory.eINSTANCE.createPrimaryKey()));

		newChildDescriptors.add
			(createChildParameter
				(Sql_metamodelPackage.Literals.TABLE__LIST_FOREIGN_KEYS,
				 Sql_metamodelFactory.eINSTANCE.createForeignKey()));

		newChildDescriptors.add
			(createChildParameter
				(Sql_metamodelPackage.Literals.TABLE__LIST_COLUMNS,
				 Sql_metamodelFactory.eINSTANCE.createColumn()));
