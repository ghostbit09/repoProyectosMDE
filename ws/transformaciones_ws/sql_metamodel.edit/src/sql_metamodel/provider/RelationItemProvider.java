...
/**
 * This is the item provider adapter for a {@link sql_metamodel.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sql_metamodelPackage.Literals.RELATION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sql_metamodelPackage.Literals.RELATION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMultiplicidadAPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relation_multiplicidadA_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relation_multiplicidadA_feature", "_UI_Relation_type"),
				 Sql_metamodelPackage.Literals.RELATION__MULTIPLICIDAD_A,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMultiplicidadBPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relation_multiplicidadB_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relation_multiplicidadB_feature", "_UI_Relation_type"),
				 Sql_metamodelPackage.Literals.RELATION__MULTIPLICIDAD_B,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public ResourceLocator getResourceLocator() {
		return Sql_metamodelEditPlugin.INSTANCE;
	}
