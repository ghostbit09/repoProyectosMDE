 ...
 * <!-- end-user-doc -->
 * @see sql_metamodel.Sql_metamodelPackage
 * @generated
 */
public class Sql_metamodelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Sql_metamodelPackage modelPackage;
	 ...
	 * @generated
	 */
	public Sql_metamodelSwitch() {
		if (modelPackage == null) {
			modelPackage = Sql_metamodelPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Sql_metamodelPackage.TABLE: {
			...
			case Sql_metamodelPackage.COLUMN: {
			...
			case Sql_metamodelPackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Sql_metamodelPackage.PRIMARY_KEY: {
