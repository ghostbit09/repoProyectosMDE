 ...
 * </p>
 * <ul>
 *   <li>{@link concreta.impl.MBSClaseImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link concreta.impl.MBSClaseImpl#getEstereotipo <em>Estereotipo</em>}</li>
 *   <li>{@link concreta.impl.MBSClaseImpl#getModificadorAcceso <em>Modificador Acceso</em>}</li>
 *   <li>{@link concreta.impl.MBSClaseImpl#isAbstracta <em>Abstracta</em>}</li>
 *   <li>{@link concreta.impl.MBSClaseImpl#getDescripcion <em>Descripcion</em>}</li>
 *   <li>{@link concreta.impl.MBSClaseImpl#getRuta <em>Ruta</em>}</li>
 *   <li>{@link concreta.impl.MBSClaseImpl#getAtributos <em>Atributos</em>}</li>
 *   <li>{@link concreta.impl.MBSClaseImpl#getMetodos <em>Metodos</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBSClaseImpl extends EObjectImpl implements MBSClase {
	...
	protected EClass eStaticClass() {
		return ConcretaPackage.Literals.MBS_CLASE;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CLASE__NOMBRE, oldNombre, nombre));
	}
	...
	public void setEstereotipo(String newEstereotipo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CLASE__ESTEREOTIPO, oldEstereotipo, estereotipo));
	}
	...
	public void setModificadorAcceso(String newModificadorAcceso) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CLASE__MODIFICADOR_ACCESO, oldModificadorAcceso, modificadorAcceso));
	}
	...
	public void setAbstracta(boolean newAbstracta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CLASE__ABSTRACTA, oldAbstracta, abstracta));
	}
	...
	public void setDescripcion(String newDescripcion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CLASE__DESCRIPCION, oldDescripcion, descripcion));
	}
	...
	public void setRuta(String newRuta) {
		...
		ruta = newRuta;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CLASE__RUTA, oldRuta, ruta));
	}
	...
	public EList<MBSAtributo> getAtributos() {
		if (atributos == null) {
			atributos = new EObjectContainmentEList<MBSAtributo>(MBSAtributo.class, this, ConcretaPackage.MBS_CLASE__ATRIBUTOS);
		}
		return atributos;
	}
	...
	public EList<MBSMetodo> getMetodos() {
		if (metodos == null) {
			metodos = new EObjectContainmentEList<MBSMetodo>(MBSMetodo.class, this, ConcretaPackage.MBS_CLASE__METODOS);
		}
		return metodos;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConcretaPackage.MBS_CLASE__ATRIBUTOS:
				return ((InternalEList<?>)getAtributos()).basicRemove(otherEnd, msgs);
			case ConcretaPackage.MBS_CLASE__METODOS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConcretaPackage.MBS_CLASE__NOMBRE:
				return getNombre();
			case ConcretaPackage.MBS_CLASE__ESTEREOTIPO:
				return getEstereotipo();
			case ConcretaPackage.MBS_CLASE__MODIFICADOR_ACCESO:
				return getModificadorAcceso();
			case ConcretaPackage.MBS_CLASE__ABSTRACTA:
				return isAbstracta();
			case ConcretaPackage.MBS_CLASE__DESCRIPCION:
				return getDescripcion();
			case ConcretaPackage.MBS_CLASE__RUTA:
				return getRuta();
			case ConcretaPackage.MBS_CLASE__ATRIBUTOS:
				return getAtributos();
			case ConcretaPackage.MBS_CLASE__METODOS:
