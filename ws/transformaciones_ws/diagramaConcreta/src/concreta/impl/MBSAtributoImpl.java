 ...
 *   <li>{@link concreta.impl.MBSAtributoImpl#getIsForeignKey <em>Is Foreign Key</em>}</li>
...
public class MBSAtributoImpl extends EObjectImpl implements MBSAtributo {
	...
	public void setIsForeignKey(Boolean newIsForeignKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_ATRIBUTO__IS_FOREIGN_KEY, oldIsForeignKey, isForeignKey));
	}
