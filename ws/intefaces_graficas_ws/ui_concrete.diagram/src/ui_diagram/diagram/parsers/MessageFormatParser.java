 ...
 * 
 */
package ui_diagram.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ui_diagram.diagram.part.Ui_diagramDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(ui_diagram.diagram.part.Messages.MessageFormatParser_InvalidInputError,
