 ...
 * @generated
 */
public class RadioButtonTitle2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RadioButtonTitle2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ui_diagram.diagram.providers.Ui_diagramParserProvider.getParser(
					ui_diagram.diagram.providers.Ui_diagramElementTypes.RadioButton_3024, getParserElement(),
