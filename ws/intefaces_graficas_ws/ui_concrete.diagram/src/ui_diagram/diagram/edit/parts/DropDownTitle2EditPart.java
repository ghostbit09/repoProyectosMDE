 ...
 * @generated
 */
public class DropDownTitle2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DropDownTitle2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ui_diagram.diagram.providers.Ui_diagramParserProvider.getParser(
					ui_diagram.diagram.providers.Ui_diagramElementTypes.DropDown_3017, getParserElement(),
