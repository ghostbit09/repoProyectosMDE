...
public class UI_DiagramEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Ui_diagram"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_diagram.diagram.edit.policies.UI_DiagramItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ui_diagram.diagram.edit.policies.UI_DiagramCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new ui_diagram.diagram.edit.commands.Ui_diagramCreateShortcutDecorationsCommand(
