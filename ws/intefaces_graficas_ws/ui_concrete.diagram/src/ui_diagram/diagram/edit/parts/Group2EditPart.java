...
public class Group2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_diagram.diagram.edit.policies.Group2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(EditPolicyRoles.OPEN_ROLE, new ui_diagram.diagram.edit.policies.OpenDiagramEditPolicy()); // XXX need an SCR to runtime to have another abstract superclass that would let children add reasonable editpolicies
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.GroupTitle2EditPart) {
			((ui_diagram.diagram.edit.parts.GroupTitle2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureGroupLabelFigure());
			return true;
		}
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getGroupLstChildModelElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getGroupLstChildModelElementsCompartmentFigure();
			pane.remove(
					((ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartment2EditPart) {
