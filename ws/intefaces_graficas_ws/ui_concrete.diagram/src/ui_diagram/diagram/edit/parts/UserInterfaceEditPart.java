...
public class UserInterfaceEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_diagram.diagram.edit.policies.UserInterfaceItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.UserInterfaceTitleEditPart) {
			((ui_diagram.diagram.edit.parts.UserInterfaceTitleEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureUserInterfaceLabelFigure());
			return true;
		}
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getUserInterfaceLstModelElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((ui_diagram.diagram.edit.parts.UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ui_diagram.diagram.edit.parts.UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart) {
