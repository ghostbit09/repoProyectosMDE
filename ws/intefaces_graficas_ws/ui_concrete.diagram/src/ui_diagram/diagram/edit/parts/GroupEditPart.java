...
public class GroupEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_diagram.diagram.edit.policies.GroupItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.GroupTitleEditPart) {
			((ui_diagram.diagram.edit.parts.GroupTitleEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureGroupLabelFigure());
			return true;
		}
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupLstChildModelElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupLstChildModelElementsCompartmentFigure();
			pane.remove(
					((ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ui_diagram.diagram.edit.parts.GroupGroupLstChildModelElementsCompartmentEditPart) {
