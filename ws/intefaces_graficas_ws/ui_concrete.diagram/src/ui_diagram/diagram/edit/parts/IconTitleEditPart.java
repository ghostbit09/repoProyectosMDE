 ...
 * @generated
 */
public class IconTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IconTitleEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ui_diagram.diagram.providers.Ui_diagramParserProvider.getParser(
					ui_diagram.diagram.providers.Ui_diagramElementTypes.Icon_3010, getParserElement(),
