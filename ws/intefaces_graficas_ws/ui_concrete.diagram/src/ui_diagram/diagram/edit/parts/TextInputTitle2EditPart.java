 ...
 * @generated
 */
public class TextInputTitle2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TextInputTitle2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ui_diagram.diagram.providers.Ui_diagramParserProvider.getParser(
					ui_diagram.diagram.providers.Ui_diagramElementTypes.TextInput_3016, getParserElement(),
