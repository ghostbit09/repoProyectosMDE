...
public class TableEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ui_diagram.diagram.edit.policies.TableItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ui_diagram.diagram.edit.parts.TableTitleEditPart) {
			((ui_diagram.diagram.edit.parts.TableTitleEditPart) childEditPart)
