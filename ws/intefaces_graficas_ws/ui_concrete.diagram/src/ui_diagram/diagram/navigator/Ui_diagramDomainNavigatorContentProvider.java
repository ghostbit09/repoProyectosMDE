 ...
 * @generated
 */
public class Ui_diagramDomainNavigatorContentProvider implements ICommonContentProvider {
		...
		if (parentElement instanceof ui_diagram.diagram.navigator.Ui_diagramDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(
							((ui_diagram.diagram.navigator.Ui_diagramDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ui_diagram.diagram.navigator.Ui_diagramDomainNavigatorItem((EObject) objects[i],
