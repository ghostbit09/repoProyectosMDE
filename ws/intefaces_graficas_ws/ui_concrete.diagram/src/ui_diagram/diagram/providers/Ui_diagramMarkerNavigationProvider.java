 ...
 * @generated
 */
public class Ui_diagramMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = ui_diagram.diagram.part.Ui_diagramDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ui_diagram.diagram.part.Ui_diagramDiagramEditorUtil.selectElementsInDiagram(editor,
