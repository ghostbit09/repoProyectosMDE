 ...
 * @generated
 */
public class Ui_diagramValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = ui_diagram.diagram.part.Ui_diagramDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ui_diagram.diagram.part.Ui_diagramDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && ui_diagram.diagram.edit.parts.UI_DiagramEditPart.MODEL_ID
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				ui_diagram.diagram.part.Ui_diagramDiagramEditorPlugin.getInstance().logError("ViewID access failure", //$NON-NLS-1$
						e);
			}
		}
