...
public class TableItemProvider extends GraphicalContainerItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UidiagramPackage.Literals.TABLE__LST_COLUMN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UidiagramPackage.Literals.TABLE__LST_COLUMN,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == UidiagramPackage.Literals.TABLE__LST_COLUMN;
