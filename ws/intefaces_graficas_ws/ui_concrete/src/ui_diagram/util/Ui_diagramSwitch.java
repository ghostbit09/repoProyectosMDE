...
public class Ui_diagramSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Ui_diagramPackage.DROP_DOWN: {
			...
			case Ui_diagramPackage.COMBO_BOX: {
