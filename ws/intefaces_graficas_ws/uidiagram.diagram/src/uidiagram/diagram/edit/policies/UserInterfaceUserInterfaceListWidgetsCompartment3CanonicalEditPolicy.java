 ...
 * @generated
 */
public class UserInterfaceUserInterfaceListWidgetsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceListWidgetsCompartment_7007SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceListWidgetsCompartment_7007SemanticChildren((View) getHost().getModel());
