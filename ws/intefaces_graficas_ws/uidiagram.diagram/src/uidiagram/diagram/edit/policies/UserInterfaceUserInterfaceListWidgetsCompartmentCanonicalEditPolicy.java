 ...
 * @generated
 */
public class UserInterfaceUserInterfaceListWidgetsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceListWidgetsCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceListWidgetsCompartment_7001SemanticChildren((View) getHost().getModel());
