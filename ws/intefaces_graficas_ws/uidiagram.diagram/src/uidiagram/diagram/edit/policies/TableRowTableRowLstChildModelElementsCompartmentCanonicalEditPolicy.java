 ...
 * @generated
 */
public class TableRowTableRowLstChildModelElementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableRowTableRowLstChildModelElementsCompartment_7008SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableRowTableRowLstChildModelElementsCompartment_7008SemanticChildren((View) getHost().getModel());
