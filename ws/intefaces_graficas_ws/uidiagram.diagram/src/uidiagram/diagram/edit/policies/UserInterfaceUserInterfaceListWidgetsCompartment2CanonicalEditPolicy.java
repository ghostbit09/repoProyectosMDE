 ...
 * @generated
 */
public class UserInterfaceUserInterfaceListWidgetsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getUserInterface_ListWidgets();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceListWidgetsCompartment_7005SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceListWidgetsCompartment_7005SemanticChildren((View) getHost().getModel());
