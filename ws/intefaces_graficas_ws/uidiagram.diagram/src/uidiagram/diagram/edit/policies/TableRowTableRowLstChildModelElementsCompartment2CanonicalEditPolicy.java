 ...
 * @generated
 */
public class TableRowTableRowLstChildModelElementsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableRowTableRowLstChildModelElementsCompartment_7010SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableRowTableRowLstChildModelElementsCompartment_7010SemanticChildren((View) getHost().getModel());
