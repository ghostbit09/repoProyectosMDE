...
public class UserInterfaceEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UserInterfaceUserInterfaceListWidgetsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getUserInterfaceListWidgetsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((UserInterfaceUserInterfaceListWidgetsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UserInterfaceUserInterfaceListWidgetsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getUserInterfaceListWidgetsCompartmentFigure();
			pane.remove(((UserInterfaceUserInterfaceListWidgetsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof UserInterfaceUserInterfaceListWidgetsCompartmentEditPart) {
