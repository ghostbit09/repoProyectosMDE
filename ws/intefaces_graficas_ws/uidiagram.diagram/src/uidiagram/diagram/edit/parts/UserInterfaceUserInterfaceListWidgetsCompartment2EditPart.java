...
import uidiagram.diagram.edit.policies.UserInterfaceUserInterfaceListWidgetsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.UserInterfaceUserInterfaceListWidgetsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UserInterfaceUserInterfaceListWidgetsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public UserInterfaceUserInterfaceListWidgetsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.UserInterfaceUserInterfaceListWidgetsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UserInterfaceUserInterfaceListWidgetsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new UserInterfaceUserInterfaceListWidgetsCompartment2CanonicalEditPolicy());
	}
