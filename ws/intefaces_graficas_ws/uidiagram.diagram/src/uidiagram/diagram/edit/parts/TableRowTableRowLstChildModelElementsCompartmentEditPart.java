...
import uidiagram.diagram.edit.policies.TableRowTableRowLstChildModelElementsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.TableRowTableRowLstChildModelElementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TableRowTableRowLstChildModelElementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public TableRowTableRowLstChildModelElementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.TableRowTableRowLstChildModelElementsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TableRowTableRowLstChildModelElementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new TableRowTableRowLstChildModelElementsCompartmentCanonicalEditPolicy());
	}
